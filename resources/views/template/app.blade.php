      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, Nur Rali Rahma Wati</div>
            </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item{{ request()->is('kepalasurat') ? ' active' : '' }}"><a href="{{ url('/kepalasurat') }}"><i class="fas fa-book-open"></i><span>Kepala Surat</span></a></li>
            <li class="nav-item{{ request()->is('namatandatgn') ? ' active' : '' }}"><a href="{{ url('/namatandatgn') }}"><i class='fas fa-clipboard-check fa-9x' style='color:#000000'></i><span>Nama Tanda Tangan</span></a></li>
            <li class="nav-item{{ request()->is('suratkeluar') ? ' active' : '' }}"><a href="{{ url('/suratkeluar') }}"><i class="fas fa-chalkboard-teacher"></i><span>Surat Keluar</span></a></li>
            <li class="nav-item{{ request()->is('suratmasuk') ? ' active' : '' }}"><a href="{{ url('/suratmasuk') }}"><i class="fas fa-users"></i><span>Surat Masuk</span></a></li>
          </ul>
            </li>
          </ul>
